...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-path',default="./61vision_test/raw_image/", type=str)
    parser.add_argument('--img-height', type=int, default=518)
    parser.add_argument('--img-width', type=int, default=644)
    parser.add_argument('--outdir', type=str, default='./61vision_test/dv2')

    parser.add_argument('--encoder', type=str, default='vitb', choices=['vits', 'vitb', 'vitl', 'vitg'])
    parser.add_argument('--load-from', type=str, default="./yzp/527/depth_anythingv2/latest_model.pth")
